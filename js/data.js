...
export const DEPARTMENTS = {
  ...
  mekatronik: {
    ...
    shortName:               'Mekatronik',
    category:                'muhendislik',
    icon:                    '🤖',
    startCost:               7_500_000,
    annualOperatingCost:     2_400_000,
    researchPotential:       4,
    labRequirement:          3,
    avgPublicationPerFaculty: 1.8,
  ...
  guzel_sanatlar: {
    ...
    icon:                    '🎨',
    startCost:               4_500_000,
    annualOperatingCost:     1_300_000,
    researchPotential:       2,
    labRequirement:          1,
    avgPublicationPerFaculty: 1.0,
    projectBudgetRange:      [50_000, 1_000_000],
    facultyRetentionDifficulty: 2,
    revenueEfficiency:       1.0,
    baseStudentDemand:       1.0,
    baseEntryScore:          [320, 410],
    tuitionMultiplier:       0.9,
  },
...
export const DEPARTMENT_CURRICULA = {
  ...
  mekatronik: [
    { id: 'mkt01', name: 'Mekatroniğe Giriş',            type: 'zorunlu', difficulty: 2, requiredExpertise: 'Mekatronik',              idealClassSize: 50, hoursPerWeek: 3 },
    { id: 'mkt02', name: 'Mekanik Sistemler',            type: 'zorunlu', difficulty: 3, requiredExpertise: 'Mekanik Sistemler',       idealClassSize: 45, hoursPerWeek: 4 },
    { id: 'mkt03', name: 'Elektrik-Elektronik Devreler', type: 'zorunlu', difficulty: 3, requiredExpertise: 'Devre Tasarımı',          idealClassSize: 45, hoursPerWeek: 4 },
    { id: 'mkt04', name: 'Mikrodenetleyiciler',          type: 'zorunlu', difficulty: 3, requiredExpertise: 'Mikrodenetleyiciler',     idealClassSize: 40, hoursPerWeek: 4 },
    { id: 'mkt05', name: 'Otomatik Kontrol',             type: 'zorunlu', difficulty: 4, requiredExpertise: 'Otomatik Kontrol',        idealClassSize: 40, hoursPerWeek: 3 },
    { id: 'mkt06', name: 'Robotik Sistemler',            type: 'seçmeli', difficulty: 4, requiredExpertise: 'Robotik',                 idealClassSize: 35, hoursPerWeek: 3 },
    { id: 'mkt07', name: 'Hidrolik ve Pnömatik',         type: 'seçmeli', difficulty: 3, requiredExpertise: 'Hidrolik-Pnömatik',       idealClassSize: 35, hoursPerWeek: 3 },
    { id: 'mkt08', name: 'Endüstriyel Otomasyon',        type: 'seçmeli', difficulty: 4, requiredExpertise: 'Endüstriyel Otomasyon',   idealClassSize: 35, hoursPerWeek: 3 },
  ],
  mimarlik: [
    { id: 'mim01', name: 'Mimari Tasarım I',             type: 'zorunlu', difficulty: 3, requiredExpertise: 'Mimari Tasarım',          idealClassSize: 40, hoursPerWeek: 6 },
    { id: 'mim02', name: 'Yapı Bilgisi',                 type: 'zorunlu', difficulty: 3, requiredExpertise: 'Yapı Teknolojileri',      idealClassSize: 45, hoursPerWeek: 4 },
    { id: 'mim03', name: 'Mimarlık Tarihi',              type: 'zorunlu', difficulty: 2, requiredExpertise: 'Mimarlık Tarihi',         idealClassSize: 50, hoursPerWeek: 3 },
    { id: 'mim04', name: 'Strüktür Sistemleri',          type: 'zorunlu', difficulty: 4, requiredExpertise: 'Yapı Teknolojileri',      idealClassSize: 40, hoursPerWeek: 3 },
    { id: 'mim05', name: 'Şehir ve Bölge Planlama',      type: 'zorunlu', difficulty: 3, requiredExpertise: 'Şehir Planlama',          idealClassSize: 45, hoursPerWeek: 3 },
    { id: 'mim06', name: 'İç Mekan Tasarımı',            type: 'seçmeli', difficulty: 2, requiredExpertise: 'İç Mimari',               idealClassSize: 35, hoursPerWeek: 3 },
    { id: 'mim07', name: 'Sürdürülebilir Mimari',        type: 'seçmeli', difficulty: 3, requiredExpertise: 'Sürdürülebilir Mimari',   idealClassSize: 40, hoursPerWeek: 3 },
    { id: 'mim08', name: 'Restorasyon ve Koruma',        type: 'seçmeli', difficulty: 4, requiredExpertise: 'Restorasyon',             idealClassSize: 30, hoursPerWeek: 3 },
  ],
  guzel_sanatlar: [
    { id: 'gsn01', name: 'Temel Sanat Eğitimi',          type: 'zorunlu', difficulty: 2, requiredExpertise: 'Görsel Sanatlar',         idealClassSize: 40, hoursPerWeek: 4 },
    { id: 'gsn02', name: 'Resim',                        type: 'zorunlu', difficulty: 3, requiredExpertise: 'Resim',                   idealClassSize: 30, hoursPerWeek: 4 },
    { id: 'gsn03', name: 'Heykel',                       type: 'zorunlu', difficulty: 3, requiredExpertise: 'Heykel',                  idealClassSize: 25, hoursPerWeek: 4 },
    { id: 'gsn04', name: 'Sanat Tarihi',                 type: 'zorunlu', difficulty: 2, requiredExpertise: 'Sanat Tarihi',            idealClassSize: 50, hoursPerWeek: 3 },
    { id: 'gsn05', name: 'Grafik Tasarım',               type: 'zorunlu', difficulty: 3, requiredExpertise: 'Grafik Tasarım',          idealClassSize: 35, hoursPerWeek: 4 },
    { id: 'gsn06', name: 'Fotoğraf',                     type: 'seçmeli', difficulty: 2, requiredExpertise: 'Fotoğraf',                idealClassSize: 30, hoursPerWeek: 3 },
    { id: 'gsn07', name: 'Çağdaş Sanat',                 type: 'seçmeli', difficulty: 3, requiredExpertise: 'Çağdaş Sanat',            idealClassSize: 35, hoursPerWeek: 3 },
    { id: 'gsn08', name: 'Görsel İletişim',              type: 'seçmeli', difficulty: 2, requiredExpertise: 'Görsel Sanatlar',         idealClassSize: 35, hoursPerWeek: 3 },
  ],
  tip: [
...
export const BUILDINGS = {
  ...
  idari_bina: {
    ...
    name:                  'İdari Bina',
    icon:                  '🏛️',
    description:           'Rektörlük ve idari birimlerin merkezi. İdari verimlilik artışı sağlar.',
    assignable:            false,
    benefitText:           'Tüm idari birimlere verimlilik bonusu sağlar',
    baseCost:              5_000_000,
    baseArea:              3000,
    upgradeCostMultiplier: 1.5,
    maxLevel:              3,
    areaPerLevel:          1500,
    capacity:              { offices: 30, classrooms: 0, labs: 0 },
    capacityPerLevel:      { offices: 15, classrooms: 0, labs: 0 },
    maintenanceCostPerM2:  40,
    constructionTurns:     1,
    canHaveMultiple:       false,
    effects: { satisfactionBonus: 3, adminEfficiency: 15 },
    // Geriye dönük uyumluluk
    constructionCost:      5_000_000,
    maintenanceCostRatio:  0.08,
    constructionTime:      1,
    upgradeCosts:          [15_000_000, 40_000_000],
    qualityEffects: {
      adminScore:          +10,
    },
    prerequisite: null,
